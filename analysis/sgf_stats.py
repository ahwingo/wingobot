...
def main():
    ...
    parser.add_argument("-d", "--sgf_dir", default="../self_play_games/sgf")
    ...
    print("Total White Wins:  {}, Average Margin of Victory: {}".format(total_white_wins,
                                                                        total_white_margin / max(1, total_white_wins)))
    print("Total Black Wins:  {}, Average Margin of Victory: {}".format(total_black_wins,
                                                                        total_black_margin / max(1, total_black_wins)))
