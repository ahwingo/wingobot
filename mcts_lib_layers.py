...
class MCTSNode:
    ...
    def __init__(self, state, parent=None, action_idx=None):
        ...
        friendly_value = 1
        friendly, enemy = get_liberty_counts_from_board(self.current_board, friendly_value)
        self.liberty_layers = [friendly, enemy]
    ...
    def expand(self, evaluator_network):
        ...
        state_w_libs.extend(self.liberty_layers)

        # Use the network to predict a move.
        prior_probs, predicted_value = evaluator_network.predict_given_state(np.reshape(state_w_libs, (1, 13, 13, 19)))
