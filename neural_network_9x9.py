...
class PolicyValueNetwork:
    ...
    def __init__(self, l2_const, starting_network_file=None):
        ...
        policy = Reshape((9*9*2,))(policy)
        policy = Dense(82, activation='softmax', name="policy")(policy)
        ...
        self.save_model_to_file("young_saigon_9x9.h5")

    def load_latest_model():
        self.model = keras.models.load_model("young_saigon_9x9.h5")
    ...
    def train(self, training_data_input, training_data_gt_value, training_data_gt_policy):
        ...
        training_model = keras.models.load_model("young_saigon_9x9.h5")
        ...
        training_model.save("young_saigon_9x9.h5")
        print("Done training!")
