...
def self_play(player, game_number, output_file):
    ...
    while num_consecutive_passes < 2 and total_moves < 169*2:
        ...
        action_idx, black_root_node = black_mcst.search(400)
        total_moves += 1
        ...
        action_idx, white_root_node = white_mcst.search(400)
        total_moves += 1
